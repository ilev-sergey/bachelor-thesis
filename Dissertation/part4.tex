...
\begin{figure}[ht]
    \centerfloat{
        ...
        \subcaptionbox{\label{fig:probe_station:wake-up} Поляризация при циклировании}{%
            \includegraphics[width=0.35\linewidth]{probe_station/wake-up.png}}
    }
...
\begin{figure}[ht]
    \centerfloat{
        \includegraphics[width=0.99\linewidth]{pfm/lateral/45mJ.png}
    }
...
\begin{figure}[ht]
    \centerfloat{
        \hfill
        \subcaptionbox[List-of-Figures entry]{\label{fig:probe_station:wake-up_all} Зависимость остаточной поляризации при циклировании}{%
            \includegraphics[width=0.49\linewidth]{probe_station/wake-up_all.png}}
        \hfill
        \subcaptionbox{\label{fig:probe_station:hysteresis} Кривые \(PV\)-гистерезиса для циклированных структур}{%
            \includegraphics[width=0.49\linewidth]{probe_station/hysteresis.png}}
        \hfill
    }
...
\nomenclature{РЭМ}{растровая электронная микроскопия}
\nomenclature{XRD}{X-ray diffraction, рентгеновская дифракция}
